...
/**
 * JWT validation using RS256 — public key only.
 * This service CANNOT issue tokens, only verify them.
 * The private key stays exclusively in auth-service.
 *
 * Pattern matches course-service JwtTokenProvider exactly.
 */
@Component
@Slf4j
